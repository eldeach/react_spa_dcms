...
useEffect(() => {
    ...
    return(
        <div>
            <MngTable getUrlStr={'/getmngbinder'} targetPk={{}} heightValue={'80vh'} tblCtrl={tblCtrl} chkSel={true} deleteButton={true} addToListButton={false} editable={true} selectButton={false}/>
        </div>
