...
useEffect(() => {
    ...
    return(
        <div>
            <MngTable getUrlStr={'/getbindermovehistory'} targetPk={{}} heightValue={'80vh'} tblCtrl={tblCtrl} chkSel={true} deleteButton={true} addToListButton={false} editable={false} selectButton={false}/>
        </div>
