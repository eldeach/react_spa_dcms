  ...
  async function LoginCheck(){
    ...
    return(
      <div style={{padding:'0.5vw'}}>
        <div>
          <MngTable getUrlStr={'/getaudittrail'} targetPk={{}} heightValue={'75vh'} tblCtrl={tblCtrl} chkSel={true} deleteButton={false} addToListButton={false} editable={false} selectButton={false}/>
        </div>
        ...
        <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0, padding:'10px' }} elevation={6}>
            <div style={{width:'100%', display:'flex', alignItems:'center', backdropFilter:'blur(10px)'}}>
                ...
                <Typography variant="BUTTON" component="div" sx={{ flexGrow: 1, overflow:'hidden', marginLeft:'4px' }}>{"Audit Trail"}</Typography>
