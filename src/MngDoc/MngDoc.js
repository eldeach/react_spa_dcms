...
function MngDoc(){
    ...
    return(
        <div style={{padding:'0.5vw'}}>
            <div>
                <MngTable getUrlStr={'/getmngdoc'} targetPk={{}} heightValue={'75vh'} tblCtrl={tblCtrl} chkSel={true} deleteButton={true} addToListButton={false} editable={true} selectButton={false}/>
            </div>
            ...
            <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0, padding:'10px' }} elevation={6}>
                <div style={{width:'100%', display:'flex', alignItems:'center', backdropFilter:'blur(10px)'}}>
                    ...
                    <Typography variant="BUTTON" component="div" sx={{ flexGrow: 1, overflow:'hidden', marginLeft:'4px' }}>{"문서정보 관리"}</Typography>
